  ...
  return (
    <>
      <form action="">
        ...
        <button className='w-full flex items-center justify-center gap-2 text-center bg-green-600 px-2 py-3 rounded-md hover:bg-green-700 cursor-pointer text-xl font-medium transition-all duration-300 mt-4'>
          Signup Now
          <MoveRight className='font-extrabold' />
        </button>

        <p className='text-white text-center font-medium mt-3 text-[16px]'>Already Have An Account ?
